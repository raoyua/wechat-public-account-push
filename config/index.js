...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxcb4a193e240d7f1e',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'c3810698e330e3bf9f747b48b356ad4e',
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'zjx5bp7FpbX8-ot5xKF6QR4bReqn9U-Z05flGSh73os',
      // 所在省份
      province: '山东',
      // 所在城市
      city: '临沂',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '鸣宝', year: '2002', date: '05-01',
        },
        {
          type: '节日', name: '恋爱时长', year: '2022', date: '04-25',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '小杨bb', year: '2002', date: '02-24',
        },
        {
  ...
  CALLBACK_TEMPLATE_ID: 'zjx5bp7FpbX8-ot5xKF6QR4bReqn9U-Z05flGSh73os',
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {
      type: '*生日', name: '鸣宝', year: '2002', date: '05-01', isShowAge: true,
    },
    {
